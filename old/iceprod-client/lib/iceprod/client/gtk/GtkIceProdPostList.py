...
logger = logging.getLogger('GtkIceProdPostList')

class GtkIceProdPostList:
    ...
    def __init__(self,iconfig,pdb,gtkmod,title="Available IceProdPost Modules"):
    ...
    def add_module(self, tv, path, viewcol):
		...
		self.iconfig.AddIceProdPost(newmod)
