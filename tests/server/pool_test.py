...
class pool_test(unittest.TestCase):
    ...
    def test_03_threadpooldeque(self):
        ...
        try:
            ...
            printer('Test pool.ThreadPoolDeque')
    ...
    def test_04_prioritythreadpool(self):
        ...
        try:
            ...
            printer('Test pool.PriorityThreadPool')
    ...
    def test_05_groupingthreadpool(self):
        ...
        try:
            ...
            printer('Test pool.GroupingThreadPool')
            
    def test_06_singlegroupingthreadpool(self):
