...
class master_communication_test(unittest.TestCase):
    ...
    def test_01_send_master(self):
        ...
        try:
            ...
            logger.error('Error running master_communication.send_master test',
                         exc_info=True)
            printer('Test master_communication.send_master',False)
            raise
        else:
            printer('Test master_communication.send_master')
