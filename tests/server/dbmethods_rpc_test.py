...
class dbmethods_rpc_test(dbmethods_base):
    ...
    def test_121_rpc_queue_master(self):
        ...
        try:
            ...
            logger.error('Error running dbmethods rpc_queue_master test - %s',str(e))
            printer('Test dbmethods rpc_queue_master',False)
            raise
        else:
            printer('Test dbmethods rpc_queue_master')
