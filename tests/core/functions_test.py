...
class functions_test(unittest.TestCase):
    ...
    def test_001_uncompress_gz(self):
        ...
        try:
            ...
            printer('Test functions.uncompress() with .gz',False)
            raise
        else:
            printer('Test functions.uncompress() with .gz')
    ...
    def test_002_uncompress_tar(self):
        ...
        try:
            ...
            logger.error('Error running uncompression test: %s',str(e))
            printer('Test functions.uncompress() with .tar.gz',False)
            raise
        else:
            printer('Test functions.uncompress() with .tar.gz')
    ...
    def test_003_uncompress_tgz(self):
        ...
        try:
            ...
            logger.error('Error running uncompression test: %s',str(e))
            printer('Test functions.uncompress() with .tgz',False)
            raise
        else:
            printer('Test functions.uncompress() with .tgz')
    ...
    def test_004_uncompress_tgz_special(self):
        ...
        try:
            ...
            logger.error('Error running uncompression test: %s',str(e))
            printer('Test functions.uncompress() with .tgz special',False)
            raise
        else:
            printer('Test functions.uncompress() with .tgz special')
    ...
    def test_005_uncompress_bz2(self):
        ...
        try:
            ...
            logger.error('Error running uncompression test: %s',str(e))
            printer('Test functions.uncompress() with .bz2',False)
            raise
        else:
            printer('Test functions.uncompress() with .bz2')
    ...
    def test_006_uncompress_tar_bz2(self):
        ...
        try:
            ...
            logger.error('Error running uncompression test: %s',str(e))
            printer('Test functions.uncompress() with .tar.bz2',False)
            raise
        else:
            printer('Test functions.uncompress() with .tar.bz2')
    ...
    def test_010_compress_gz(self):
        ...
        try:
            ...
            printer('Test functions.compress() with .gz',False)
            raise
        else:
            printer('Test functions.compress() with .gz')
    ...
    def test_011_compress_lzma(self):
        ...
        try:
            ...
            logger.error('Error running compression test: %s',str(e))
            printer('Test functions.compress() with .lzma',False)
            raise
        else:
            printer('Test functions.compress() with .lzma')
    ...
    def test_012_compress_tar_gz(self):
        ...
        try:
            ...
            printer('Test functions.tar() and functions.compress() with .tar.gz',False)
            raise
        else:
            printer('Test functions.tar() and functions.compress() with .tar.gz')
    ...
    def test_013_compress_tar_lzma(self):
        ...
        try:
            ...
            logger.error('Error running tar and compression test: %s',str(e))
            printer('Test functions.tar() and functions.compress() with .tar.lzma',False)
            raise
        else:
            printer('Test functions.tar() and functions.compress() with .tar.lzma')
    ...
    def test_020_iscompressed(self):
        ...
        try:
            ...
            logger.error('Error running iscompressed test: %s',str(e))
            printer('Test functions.iscompressed()',False)
            raise
        else:
            printer('Test functions.iscompressed()')
    ...
    def test_021_istarred(self):
        ...
        try:
            ...
            logger.error('Error running istarred test: %s',str(e))
            printer('Test functions.istarred()',False)
            raise
        else:
            printer('Test functions.istarred()')
    ...
    def test_100_md5sum(self):
        ...
        try:
            ...
            logger.error('Error running md5sum test: %s',str(e))
            printer('Test functions.md5sum()',False)
            raise
        else:
            printer('Test functions.md5sum()')
    ...
    def test_101_check_md5sum(self):
        ...
        try:
            ...
            logger.error('Error running check_md5sum test: %s',str(e))
            printer('Test functions.check_md5sum()',False)
            raise
        else:
            printer('Test functions.check_md5sum()')
    ...
    def test_102_sha1sum(self):
        ...
        try:
            ...
            logger.error('Error running sha1sum test: %s',str(e))
            printer('Test functions.sha1sum()',False)
            raise
        else:
            printer('Test functions.sha1sum()')
    ...
    def test_103_check_sha1sum(self):
        ...
        try:
            ...
            logger.error('Error running check_sha1sum test: %s',str(e))
            printer('Test functions.check_sha1sum()',False)
            raise
        else:
            printer('Test functions.check_sha1sum()')
    ...
    def test_104_sha256sum(self):
        ...
        try:
            ...
            logger.error('Error running sha256sum test: %s',str(e))
            printer('Test functions.sha256sum()',False)
            raise
        else:
            printer('Test functions.sha256sum()')
    ...
    def test_105_check_sha256sum(self):
        ...
        try:
            ...
            logger.error('Error running check_sha256sum test: %s',str(e))
            printer('Test functions.check_sha256sum()',False)
            raise
        else:
            printer('Test functions.check_sha256sum()')
    ...
    def test_106_sha512sum(self):
        ...
        try:
            ...
            logger.error('Error running sha512sum test: %s',str(e))
            printer('Test functions.sha512sum()',False)
            raise
        else:
            printer('Test functions.sha512sum()')
    ...
    def test_107_check_sha512sum(self):
        ...
        try:
            ...
            logger.error('Error running check_sha512sum test: %s',str(e))
            printer('Test functions.check_sha512sum()',False)
            raise
        else:
            printer('Test functions.check_sha512sum()')
    ...
    def test_200_removedirs(self):
        ...
        try:
            ...
            logger.error('Error running removedirs test: %s',str(e))
            printer('Test functions.removedirs()',False)
            raise
        else:
            printer('Test functions.removedirs()')
    ...
    def test_201_copy(self):
        ...
        try:
            ...
            printer('Test functions.copy()',False)
            raise
        else:
            printer('Test functions.copy()')
    ...
    def test_202_find_regex(self):
        ...
        try:
            ...
            logger.error('Error running find_regex test: %s',str(e))
            printer('Test functions.find_regex()',False)
            raise
        else:
            printer('Test functions.find_regex()')
    ...
    def test_203_find_unix(self):
        ...
        try:
            ...
            logger.error('Error running find_unix test: %s',str(e))
            printer('Test functions.find_unix()',False)
            raise
        else:
            printer('Test functions.find_unix()')
    ...
    def test_204_find_glob(self):
        ...
        try:
            ...
            logger.error('Error running find_glob test: %s',str(e))
            printer('Test functions.find_glob()',False)
            raise
        else:
            printer('Test functions.find_glob()')
    ...
    def test_205_tail(self):
        ...
        try:
            ...
            logger.error('Error running tail test: %s',str(e))
            printer('Test functions.tail()',False)
            raise
        else:
            printer('Test functions.tail()')
    ...
    def test_300_getInterfaces(self):
        ...
        try:
            ...
            logger.error('Error running getInterfaces test: %s',str(e))
            printer('Test functions.getInterfaces()',False)
            raise
        else:
            printer('Test functions.getInterfaces()')
    ...
    def test_301_gethostname(self):
        ...
        try:
            ...
            logger.error('Error running gethostname test: %s',str(e))
            printer('Test functions.gethostname()',False)
            raise
        else:
            printer('Test functions.gethostname()')
    ...
    def test_302_isurl(self):
        ...
        try:
            ...
            logger.error('Error running isurl test: %s',str(e))
            printer('Test functions.isurl()',False)
            raise
        else:
            printer('Test functions.isurl()')
    ...
    def test_303_wget(self):
        ...
        try:
            ...
            logger.error('Error running wget test: %s',str(e))
            printer('Test functions.wget()',False)
            raise
        else:
            printer('Test functions.wget()')
    ...
    def test_304_download(self):
        ...
        try:
            ...
            logger.error('Error running download test: %s',str(e))
            printer('Test functions.download()',False)
            raise
        else:
            printer('Test functions.download()')
    ...
    def test_305_download_cached(self):
        ...
        try:
            ...
            logger.error('Error running download test with caching: %s',str(e))
            printer('Test functions.download(cache=True)',False)
            raise
        else:
            printer('Test functions.download(cache=True)')
    ...
    def test_400_wput(self):
        ...
        try:
            ...
            logger.error('Error running wput test: %s',str(e))
            printer('Test functions.wput()',False)
            raise
        else:
            printer('Test functions.wput()')
    ...
    def test_401_wput(self):
        ...
        try:
            ...
            logger.error('Error running wput proxy test: %s',str(e))
            printer('Test functions.wput(proxy=True)',False)
            raise
        else:
            printer('Test functions.wput(proxy=True)')
    ...
    def test_402_upload(self):
        ...
        try:
            ...
            logger.error('Error running upload test: %s',str(e))
            printer('Test functions.upload()',False)
            raise
        else:
            printer('Test functions.upload()')
    ...
    def test_403_upload(self):
        ...
        try:
            ...
            logger.error('Error running upload proxy test: %s',str(e))
            printer('Test functions.upload(proxy=True)',False)
            raise
        else:
            printer('Test functions.upload(proxy=True)')
    ...
    def test_404_upload(self):
        ...
        try:
            ...
            logger.error('Error running upload proxy prefix test: %s',str(e))
            printer('Test functions.upload(proxy=prefix)',False)
            raise
        else:
            printer('Test functions.upload(proxy=prefix)')
    ...
    def test_500_getuser(self):
        ...
        try:
            ...
            logger.error('Error running getuser test: %s',str(e))
            printer('Test functions.getuser',False)
            raise
        else:
            printer('Test functions.getuser')
    ...
    def test_501_platform(self):
        ...
        try:
            ...
            logger.error('Error running platform test: %s',str(e))
            printer('Test functions.platform',False)
            raise
        else:
            printer('Test functions.platform')
