        ...
        if f:
            for data in files:
                ...
                if data.url.startswith('gsiftp://'):
                    ...
                    cmd = [
                        '/cvmfs/icecube.opensciencegrid.org/users/dschultz/dumb_pelican_client-0.1.3/dumb_pelican_client',
                        '--log-level=info',
                        'object',
                        'get',
                        data.url,
            ...
            if args is not None and args != '':
                ...
                def splitter(a,b):
                    ...
                    if b is None:
                        ...
                        return ret+'='+str(b)
                args = args['args'] + [splitter(a, args['kwargs'][a]) for a in args['kwargs']]  # ty: ignore
