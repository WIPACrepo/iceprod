...
Role checks are generally more difficult, involving a database lookup::
    ...
    def _rpc_edit_dataset_helper(self, auth_roles, dataset_id, *args, **kwargs):
        """
        Args:
            auth_roles (list): role_ids of logged in user
